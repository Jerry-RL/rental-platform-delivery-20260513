...
### 2.4 客户痛点驱动补充（2026-06-01，SRS v1.9）

以下项已写入 [业务背景与客户痛点说明](./租车平台业务背景与客户痛点说明.md) 及 SRS v1.9，评审时纳入一期排期：

| 原缺口 | 文档落点 | 优先级 |
|---|---|---|
| 手工下单、无经营看板 | FR-OPS-004~009、痛点 P-ORDER/P-OPS | P0/P1 |
| 租期事故与结算脱节 | FR-ORD-008~012、BR-030~034 | P0 |
| 认证场景粗（代订车、企业资质） | FR-USER-011~021、BR-035~037 | P0 |
| 发票对公打款难对齐 | FR-FIN-007~009、BR-038 | P0 |
...
- 用户注册登录、实名与驾照审核（**v1.9 细化**：代订车驾驶人、企业资质、授信快照，见 [需求补充（事故+认证）](./租车平台需求补充说明书（事故处理+用户认证细化）.md)）
- **租期事故上报与车辆事故停运**（FR-ORD-008~012，v1.9）
- **对公回款识别码 + 银行流水匹配**（FR-FIN-007~008，v1.9）
...
> 定价维度（按时间/里程、车型、数量、自驾/包司机）与费用拆分规则见 [租车平台订单定价策略说明.md](./租车平台订单定价策略说明.md) §9。
